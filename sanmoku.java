...
public class Rensyu extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (checkWinner()) {
            highlightWinner();
            JOptionPane.showMessageDialog(this, currentPlayer + "勝った！！！");
            resetBoard();
        } else if (isDraw()) {
    ...
    private void highlightWinner() {
        for (int[] pos : winLine) {
            buttons[pos[0]][pos[1]].setBackground(Color.BLUE);
        }
    }
